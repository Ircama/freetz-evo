...
miniupnpd is a lightweight UPnP Internet Gateway Device (IGD) daemon that implements automatic port forwarding via UPnP, allowing devices on the LAN to request inbound port mappings.