...
$(PKG)_EXCLUDED += $(if $(FREETZ_SKIN_evo),,usr/share/*/evo)
...
$(PKG)_EXCLUDED += $(if $(FREETZ_STYLE_COLORED),,usr/share/style/colorscheme-colored.css)
$(PKG)_EXCLUDED += $(if $(FREETZ_STYLE_GREY),,usr/share/style/colorscheme-grey.css)
$(PKG)_EXCLUDED += $(if $(FREETZ_STYLE_MODERN),,usr/share/style/colorscheme-modern.css)
...
$(PKG)_EXCLUDED += $(if $(EXTERNAL_ENABLED),,/usr/mww/cgi-bin/update/external.cgi /usr/mww/cgi-bin/update/do_external.cgi /usr/mww/cgi-bin/update/do_external_url.cgi)
