...
cat << EOF
	<div style="clear: both; text-align: right;"><button type="button" onclick="location.href='external.cgi'">$(lang de:"external-Datei hochladen (optional)" en:"upload external file (optional)")</button></div>
EOF
fi
