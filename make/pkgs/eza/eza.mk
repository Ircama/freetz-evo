...
$(PKG)_SOURCE:=$(pkg)-$(EZA_VERSION).tar.gz
...
$(PKG)_TARGET_BINARY:=$(EZA_DEST_DIR)/usr/bin/eza
...
$(eval $(call INSTALL_BINARY_STRIP_RULE,$(EZA_BINARY),/usr/bin))

$(pkg):

$(pkg)-precompiled: $(EZA_TARGET_BINARY)

$(pkg)-clean:
	-$(SUBMAKE) -C $(EZA_DIR) clean
	$(RM) -r $(EZA_BINARY) $(EZA_DIR)/.configured $(EZA_CARGO_HOME) $(EZA_DIR)/target

$(pkg)-uninstall:
	$(RM) $(EZA_TARGET_BINARY)
