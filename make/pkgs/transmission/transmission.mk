...
ifeq ($(strip $(FREETZ_PACKAGE_TRANSMISSION_WITH_MBEDTLS)),y)
$(PKG)_CONFIGURE_OPTIONS += -DMBEDTLS_INCLUDE_DIRS="$(TARGET_TOOLCHAIN_STAGING_DIR)/usr/include"
endif
ifeq ($(strip $(FREETZ_PACKAGE_TRANSMISSION_WITH_OPENSSL)),y)
$(PKG)_CONFIGURE_OPTIONS += -DOPENSSL_INCLUDE_DIR="$(TARGET_TOOLCHAIN_STAGING_DIR)/usr/include"
endif
$(PKG)_CONFIGURE_OPTIONS += -DCURL_INCLUDE_DIR="$(TARGET_TOOLCHAIN_STAGING_DIR)/usr/include"
$(PKG)_CONFIGURE_OPTIONS += -DDEFLATE_INCLUDE_DIR="$(TARGET_TOOLCHAIN_STAGING_DIR)/usr/include"
$(PKG)_CONFIGURE_OPTIONS += -DEVENT2_INCLUDE_DIR="$(TARGET_TOOLCHAIN_STAGING_DIR)/usr/include"
$(PKG)_CONFIGURE_OPTIONS += -DPSL_INCLUDE_DIR="$(TARGET_TOOLCHAIN_STAGING_DIR)/usr/include"
