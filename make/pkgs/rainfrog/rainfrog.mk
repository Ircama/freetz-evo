...
$(PKG)_SOURCE:=$(pkg)-$(RAINFROG_VERSION).tar.gz
...
$(PKG)_TARGET_BINARY:=$(RAINFROG_DEST_DIR)/usr/bin/rainfrog
...
$(RAINFROG_BINARY): $(RAINFROG_DIR)/.configured
	cd $(RAINFROG_DIR); \
...
$(eval $(call INSTALL_BINARY_STRIP_RULE,$(RAINFROG_BINARY),/usr/bin))

$(pkg):

$(pkg)-precompiled: $(RAINFROG_TARGET_BINARY)
