...
$(pkg)-clean:
	...
	-[ ! -d $(GO_LIBRESPOT_GO_MODCACHE) ] || chattr -R -i $(GO_LIBRESPOT_GO_MODCACHE) 2>/dev/null || true
	-[ ! -d $(GO_LIBRESPOT_GO_MODCACHE) ] || chmod -R u+w $(GO_LIBRESPOT_GO_MODCACHE) 2>/dev/null || true
	-[ ! -d $(GO_LIBRESPOT_GO_CACHE) ] || chattr -R -i $(GO_LIBRESPOT_GO_CACHE) 2>/dev/null || true
