...
ELFINDER_JQUERYUI_REMOTE_SOURCE := jquery-ui.min.js
...
ELFINDER_JQUERYUI_CSS_REMOTE_SOURCE := jquery-ui.min.css
...
$(DL_DIR)/$(ELFINDER_JQUERYUI_SOURCE): | $(DL_DIR)
	$(DL_TOOL) -o $(ELFINDER_JQUERYUI_SOURCE) $(DL_DIR) $(ELFINDER_JQUERYUI_REMOTE_SOURCE) $(ELFINDER_JQUERYUI_SITE) $(ELFINDER_JQUERYUI_HASH)

$(DL_DIR)/$(ELFINDER_JQUERYUI_CSS_SOURCE): | $(DL_DIR)
	$(DL_TOOL) -o $(ELFINDER_JQUERYUI_CSS_SOURCE) $(DL_DIR) $(ELFINDER_JQUERYUI_CSS_REMOTE_SOURCE) $(ELFINDER_JQUERYUI_CSS_SITE) $(ELFINDER_JQUERYUI_CSS_HASH)
