...
$(PKG)_CONFIGURE_OPTIONS += -DWITH_NPUPNP=OFF
$(PKG)_CONFIGURE_OPTIONS += -DWITH_ICU=OFF
$(PKG)_CONFIGURE_OPTIONS += -DWITH_JS=OFF
$(PKG)_CONFIGURE_OPTIONS += -DWITH_AVCODEC=OFF
$(PKG)_CONFIGURE_OPTIONS += -DWITH_WAVPACK=OFF
$(PKG)_CONFIGURE_OPTIONS += -DWITH_FFMPEGTHUMBNAILER=OFF
$(PKG)_CONFIGURE_OPTIONS += -DWITH_EXIF=OFF
$(PKG)_CONFIGURE_OPTIONS += -DWITH_EXIV2=OFF
$(PKG)_CONFIGURE_OPTIONS += -DWITH_MATROSKA=OFF
...
# Taglib requires >= 1.12; the freetz taglib package ships 1.6.3 so always disable
$(PKG)_CONFIGURE_OPTIONS += -DWITH_TAGLIB=OFF
# LibMagic not packaged in freetz cross-toolchain, always disable
$(PKG)_CONFIGURE_OPTIONS += -DWITH_MAGIC=OFF
