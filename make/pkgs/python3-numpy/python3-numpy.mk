$(call PKG_INIT_BIN, $(if $(FREETZ_PACKAGE_PYTHON3_NUMPY_VERSION_ABANDON),2.3.2,$(if $(FREETZ_PACKAGE_PYTHON3_NUMPY_VERSION_OLD),2.4.3,2.5.0)))
...
$(PKG)_HASH_OLD:=483a201202b73495f00dbc83796c6ae63137a9bdade074f7648b3e32613412dd
$(PKG)_HASH_CURRENT:=5a129578019311b6e56bdd714250f19b518f7dceeeb8d1af5490f4942d3f891c
$(PKG)_HASH:=$($(PKG)_HASH_$(if $(FREETZ_PACKAGE_PYTHON3_NUMPY_VERSION_ABANDON),ABANDON,$(if $(FREETZ_PACKAGE_PYTHON3_NUMPY_VERSION_OLD),OLD,CURRENT)))
...
$(PKG)_REBUILD_SUBOPTS += FREETZ_PACKAGE_PYTHON3_NUMPY_VERSION_OLD
