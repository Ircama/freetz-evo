...
$(PKG)_DEPENDS_ON += $(if $(FREETZ_PACKAGE_FFMPEG_LIBMP3LAME),lame)
...
$(PKG)_DEMUXERS  := aac ac3 avi flv h264 hls image2 matroska mjpeg mov mp3 mpegps mpegts mpegvideo ogg rm rtsp sdp v4l2
...
$(PKG)_REBUILD_SUBOPTS += FREETZ_PACKAGE_FFMPEG_FULL_SUPPORT
$(PKG)_REBUILD_SUBOPTS += FREETZ_PACKAGE_FFMPEG_LZMA
$(PKG)_REBUILD_SUBOPTS += FREETZ_PACKAGE_FFMPEG_LIBMP3LAME
...
$(PKG)_CONFIGURE_OPTIONS += $(if $(FREETZ_PACKAGE_FFMPEG_FULL_SUPPORT),--disable-small,--enable-small)
...
$(PKG)_CONFIGURE_OPTIONS += $(if $(FREETZ_PACKAGE_FFMPEG_LIBMP3LAME),--enable-libmp3lame,--disable-libmp3lame)
...
$(PKG)_CONFIGURE_OPTIONS += $(if $(FREETZ_PACKAGE_FFMPEG_FULL_SUPPORT),,--disable-bsfs)
$(PKG)_CONFIGURE_OPTIONS += $(if $(FREETZ_PACKAGE_FFMPEG_FULL_SUPPORT),,--disable-devices)
$(PKG)_CONFIGURE_OPTIONS += $(if $(FREETZ_PACKAGE_FFMPEG_FULL_SUPPORT),,--disable-filters)
