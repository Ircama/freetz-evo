...
$(DNSDIST_BOOST_MARKER): $(DL_DIR)/$(DNSDIST_BOOST_SOURCE) $(DNSDIST_DIR)/.unpacked
	...
	cd $(DNSDIST_BOOST_ROOT) && ./b2 --user-config=$(abspath $(DNSDIST_BOOST_CONFIG)) toolset=gcc-freetz target-os=linux link=static runtime-link=shared variant=release threading=multi cxxstd=17 --layout=system stage $(SILENT)
	@touch $@
