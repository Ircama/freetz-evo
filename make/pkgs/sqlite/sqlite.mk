$(call PKG_INIT_BIN, $(if $(FREETZ_LIB_libsqlite3_WITH_VERSION_ABANDON),3400100,$(if $(FREETZ_LIB_libsqlite3_WITH_VERSION_STABLE),3470100,3530300)))
$(PKG)_LIB_VERSION_ABANDON:=0.8.6
$(PKG)_LIB_VERSION_STABLE:=0.8.6
$(PKG)_LIB_VERSION_CURRENT:=3.53.3
...
$(PKG)_CONFIGURE_OPTIONS += --with-readline-cflags="-I$(TARGET_TOOLCHAIN_STAGING_DIR)/usr/include"
$(PKG)_CONFIGURE_OPTIONS += --with-readline-ldflags="-L$(TARGET_TOOLCHAIN_STAGING_DIR)/usr/lib -lreadline -lncurses"
endif
endif
...
$($(PKG)_LIB_STAGING_BINARY): $($(PKG)_LIB_BINARY)
	...
	$(PKG_FIX_LIBTOOL_LA) \
		...
		$(if $(or $(FREETZ_LIB_libsqlite3_WITH_VERSION_ABANDON),$(FREETZ_LIB_libsqlite3_WITH_VERSION_STABLE)),$(TARGET_TOOLCHAIN_STAGING_DIR)/usr/lib/libsqlite3.la)
else
