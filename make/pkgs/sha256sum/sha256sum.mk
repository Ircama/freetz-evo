...
$(PKG)_SOURCE:=$(pkg)-$(SHA256SUM_VERSION).tar.gz
...
$(PKG)_TARGET_BINARY:=$(SHA256SUM_DEST_DIR)/usr/bin/sha256sum
...
$(SHA256SUM_BINARY): $(SHA256SUM_DIR)/.configured
	cd $(SHA256SUM_DIR); \
...
$(eval $(call INSTALL_BINARY_STRIP_RULE,$(SHA256SUM_BINARY),/usr/bin,,sha256sum))

$(pkg):

$(pkg)-precompiled: $(SHA256SUM_TARGET_BINARY)

$(pkg)-clean:
	-$(SUBMAKE) -C $(SHA256SUM_DIR) clean
	$(RM) $(SHA256SUM_BINARY) $(SHA256SUM_DIR)/.configured $(SHA256SUM_DIR)/.cargo/config.toml

$(pkg)-uninstall:
	$(RM) $(SHA256SUM_TARGET_BINARY)
