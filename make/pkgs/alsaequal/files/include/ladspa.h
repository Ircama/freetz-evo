/*
 * Minimal LADSPA 1.1 API definitions required to build alsaequal.
 *
 * This header intentionally contains only the core types, macros and
 * function declarations used by alsaequal and its helper code.
 */
