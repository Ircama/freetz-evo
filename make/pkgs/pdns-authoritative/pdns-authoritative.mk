...
$(PKG)_REBUILD_SUBOPTS += FREETZ_PACKAGE_POWERDNS_ZONE2LDAP
...
$(PKG)_CONFIGURE_OPTIONS += $(if $(FREETZ_PACKAGE_POWERDNS_BACKEND_GPGSQL),--with-pg-config=$(TARGET_TOOLCHAIN_STAGING_DIR)/usr/bin/pg_config)
...
$(PKG)_EXCLUDED += $(if $(FREETZ_PACKAGE_POWERDNS_ZONE2LDAP),,usr/bin/zone2ldap)
...
$(pkg)-uninstall:
	$(RM) -r \
		...
		$(POWERDNS_DEST_DIR)/usr/bin/zone2ldap \
