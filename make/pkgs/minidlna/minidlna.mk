...
$(PKG)_CONDITIONAL_PATCHES+=$(if $(FREETZ_PACKAGE_MINIDLNA_LANG_IT),it)
$(PKG)_CONDITIONAL_PATCHES+=$(if $(FREETZ_PACKAGE_MINIDLNA_LANG_FR),fr)
$(PKG)_CONDITIONAL_PATCHES+=$(if $(FREETZ_PACKAGE_MINIDLNA_LANG_ES),es)
...
$(PKG)_REBUILD_SUBOPTS += FREETZ_PACKAGE_MINIDLNA_LANG_IT
$(PKG)_REBUILD_SUBOPTS += FREETZ_PACKAGE_MINIDLNA_LANG_FR
$(PKG)_REBUILD_SUBOPTS += FREETZ_PACKAGE_MINIDLNA_LANG_ES
