...
s! {
    ...
    pub struct siginfo_t {
        ...
        pub si_errno: c_int,       // if not zero: error value of signal, see errno.
        pub si_code: c_int,        // signal code
        _pad: [c_int; 29],     // padding to 128 bytes
    }

    pub struct shmid_ds {
        pub shm_perm: crate::ipc_perm,
        __shm_pad1: Padding<c_ulong>,
        pub shm_segsz: size_t,
        __shm_pad2: Padding<c_ulong>,
        pub shm_atime: time_t,
        __shm_pad3: Padding<c_ulong>,
        pub shm_dtime: time_t,
        __shm_pad4: Padding<c_ulong>,
        pub shm_ctime: time_t,
        __shm_pad5: Padding<c_ulong>,
        pub shm_cpid: crate::pid_t,
        pub shm_lpid: crate::pid_t,
        pub shm_nattch: crate::shmatt_t,
        __shm_pad6: Padding<c_ulong>,
        __unused1: Padding<c_ulong>,
        __unused2: Padding<c_ulong>,
    }
    ...
    pub struct msqid_ds {
        ...
        __msg_pad1: Padding<c_ulong>,
        pub msg_stime: time_t,
        __msg_pad2: Padding<c_ulong>,
        pub msg_rtime: time_t,
        __msg_pad3: Padding<c_ulong>,
        pub msg_ctime: time_t,
        __msg_pad4: Padding<c_ulong>,
        __msg_cb: Padding<c_ulong>,
        __msg_qnum: Padding<c_ulong>,
        __msg_qbytes: Padding<c_ulong>,
        __msg_lspid: Padding<c_ulong>,
        __msg_lrpid: Padding<c_ulong>,
    }
