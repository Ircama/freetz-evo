...
$($(PKG)_STAGING_BINARY): $($(PKG)_BINARY)
	$(SUBMAKE) -C $(POPT_DIR) \
		...
		install
	# Ensure popt.pc is staged (make install may skip it in some configurations)
	install -D -m 644 $(POPT_DIR)/popt.pc \
		$(TARGET_TOOLCHAIN_STAGING_DIR)/usr/lib/pkgconfig/popt.pc
	$(PKG_FIX_LIBTOOL_LA) \
